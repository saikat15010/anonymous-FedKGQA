...
def main(args):
    ...
    logging.info("="*70)
    logging.info("FedKGQA — DistilBERT + ComplEx | PQ-3H | Client 3")
    logging.info("="*70)
    ...
    fkgqa = FederatedKGQA(args, clients, gnr, qa_model_distilbert)
...
if __name__ == '__main__':
    ...
    p.add_argument('--name', type=str, default='distilbert_complex_pq3h')
