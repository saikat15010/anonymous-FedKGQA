...
def main(args):
    ...
    logging.info("="*70)
    logging.info("FedKGQA — BERT + ComplEx | PQ-3H | Client 3")
    logging.info("="*70)
    ...
    fkgqa = FederatedKGQA(args, clients, gnr, qa_model_bert)
...
if __name__ == '__main__':
    ...
    p.add_argument('--name', type=str, default='bert_complex_pq3h')
