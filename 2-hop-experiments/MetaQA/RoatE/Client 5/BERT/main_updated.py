...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - RotatE + BERT")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: RotatE for KG, BERT for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on MetaQA with RotatE + BERT')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_rotate_bert',
    ...
    parser.add_argument('--hidden_dim', type=int, default=256,
                       help='Embedding dimension (RotatE: entities=2*hidden_dim, relations=hidden_dim) - INCREASED FOR BETTER PERFORMANCE')
    parser.add_argument('--gamma', type=float, default=12.0,
                       help='Margin for RotatE')
    ...
    parser.add_argument('--qa_batch_size', type=int, default=16,
                       help='Batch size for QA training (smaller for BERT)')
