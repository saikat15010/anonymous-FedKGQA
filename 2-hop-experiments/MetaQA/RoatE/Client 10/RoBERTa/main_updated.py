...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - RotatE + RoBERTa")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: RotatE for KG, RoBERTa for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on MetaQA with RotatE + RoBERTa')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_rotate_roberta',
