...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info(f"Federated KGQA Training - {args.kge_model.upper()} + RoBERTa")
    logging.info("=" * 70)
    ...
    logging.info(f"QA Model: RoBERTa")
    ...
    logging.info(f"To evaluate on server test set, run: python server_eval_all.py --kge_model {args.kge_model}")


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on MetaQA with Multiple KGE Models + RoBERTa')
    ...
    parser.add_argument('--name', type=str, default=None,
                       help='Experiment name (default: fkgqa_{kge_model}_roberta)')
    ...
    if args.name is None:
        args.name = f'fkgqa_{args.kge_model}_roberta'
