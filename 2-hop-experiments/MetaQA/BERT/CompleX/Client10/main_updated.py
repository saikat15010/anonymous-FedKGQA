...
from fkgqa_updated import FederatedKGQA
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - ComplEx + RoBERTa")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"KG Model: ComplEx")
    logging.info(f"QA Encoder: {args.encoder_type.upper()}")
    ...
    logging.info(f"To evaluate on server test set, run: python server_eval.py")


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on MetaQA with ComplEx + RoBERTa')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_complex_roberta',
    ...
    parser.add_argument('--hidden_dim', type=int, default=256,
                       help='Embedding dimension (ComplEx uses 2*hidden_dim) - INCREASED FOR BETTER PERFORMANCE')
    ...
    parser.add_argument('--encoder_type', type=str, default='roberta',
                       ...
                       help='Question encoder type: bert, distilbert, or roberta (default: roberta)')
    ...
    parser.add_argument('--qa_max_rounds', type=int, default=200,
                       help='Maximum rounds for QA training - INCREASED FOR BETTER CONVERGENCE')
    ...
    parser.add_argument('--qa_lr', type=float, default=1e-5,
                       help='Learning rate for QA training - LOWERED FOR STABILITY')
