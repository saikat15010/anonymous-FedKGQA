...
from fkgqa_pathquestion_rotate import FederatedKGQA
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - DistilBERT + RotatE")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: RotatE for KG, DistilBERT for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with DistilBERT + RotatE')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_distilbert_rotate',
    ...
    parser.add_argument('--hidden_dim', type=int, default=256,
                       help='Embedding dimension (RotatE: entities=hidden_dim, relations=hidden_dim)')
