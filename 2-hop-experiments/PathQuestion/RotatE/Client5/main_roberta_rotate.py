...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - RoBERTa + RotatE")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with RoBERTa + RotatE')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_roberta_rotate',
