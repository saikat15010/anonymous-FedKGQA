"""
Server-side Evaluation Script for BERT-RotatE on PathQuestion
"""
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("BERT-RotatE Server Evaluation on PathQuestion")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate BERT-RotatE on PathQuestion')
