"""
Server-side Evaluation Script for DistilBERT-RotatE on PathQuestion
"""
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("DistilBERT-RotatE Server Evaluation on PathQuestion")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate DistilBERT-RotatE on PathQuestion')
