...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - BERT + RotatE")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with BERT + RotatE')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_bert_rotate',
