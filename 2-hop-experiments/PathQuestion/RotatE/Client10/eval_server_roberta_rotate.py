"""
Server-side Evaluation Script for RoBERTa-RotatE on PathQuestion
"""
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("RoBERTa-RotatE Server Evaluation on PathQuestion")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate RoBERTa-RotatE on PathQuestion')
