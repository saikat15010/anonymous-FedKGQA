...
Phase 1: Federated KG Embedding Training (DistMult with global relations)
...
from kge_model_distmult import (
    DistMultModel,
...
class FederatedKGQA:
    ...
    def __init__(self, args, all_clients_data, global_nrelation, qa_model_module):
        ...
        # DistMult: relations are translations, size = hidden_dim
    ...
    def setup_clients(self, kg_dataloaders, train_qa_loaders, dev_qa_loaders):
        ...
        for i, client_data in enumerate(self.all_clients_data):
            ...
            # Initialize entity embeddings (DistMult: hidden_dim, then normalize)
            ...
            # Normalize to unit sphere for DistMult
            # DistMult does not require normalization
            ...
            # Initialize KG model (DistMult)
            kg_model = DistMultModel(self.args)
    ...
    def train_phase1_kg(self):
        ...
        logging.info("\n" + "=" * 70)
        logging.info("PHASE 1: Federated KG Embedding Training (DistMult)")
        logging.info("=" * 70)
