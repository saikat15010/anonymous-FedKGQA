...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - RoBERTa + DistMult")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: DistMult for KG, RoBERTa for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with RoBERTa + DistMult')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_roberta_distmult',
