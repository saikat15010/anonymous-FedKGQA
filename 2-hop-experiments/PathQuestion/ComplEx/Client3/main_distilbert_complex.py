...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - DistilBERT + ComplEx")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: ComplEx for KG, DistilBERT for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with DistilBERT + ComplEx')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_distilbert_complex',
