"""
Server-side Evaluation Script for DistilBERT-ComplEx on PathQuestion
"""
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("DistilBERT-ComplEx Server Evaluation on PathQuestion")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate DistilBERT-ComplEx on PathQuestion')
