"""
Server-side Evaluation Script for RoBERTa-TransE on PathQuestion
"""
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("RoBERTa-TransE Server Evaluation on PathQuestion")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate RoBERTa-TransE on PathQuestion')
