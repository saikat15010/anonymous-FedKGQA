...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - BERT + TransE")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: TransE for KG, BERT for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with BERT + TransE')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_bert_transe',
