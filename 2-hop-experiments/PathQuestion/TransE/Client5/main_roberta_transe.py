...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - RoBERTa + TransE")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: TransE for KG, RoBERTa for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with RoBERTa + TransE')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_roberta_transe',
