...
class DistilBertQuestionEncoder(nn.Module):
    """Question encoder using DistilBERT"""
    def __init__(self, args, hidden_dim):
        super(DistilBertQuestionEncoder, self).__init__()
        self.args = args
    ...
    def forward(self, questions):
        ...
        # Use [CLS] token (first token in DistilBERT)
...
class ImprovedKGQAModel(nn.Module):
    ...
    def __init__(self, args, nentity, nrelation):
        ...
        # Question encoder
        self.question_encoder = DistilBertQuestionEncoder(args, args.hidden_dim)
