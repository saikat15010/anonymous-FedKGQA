...
Phase 1: Federated KG Embedding Training (TransE with global relations)
...
class FederatedKGQA:
    ...
    def __init__(self, args, all_clients_data, global_nrelation, qa_model_module):
        ...
        # TransE: relations are translations, size = hidden_dim
    ...
    def setup_clients(self, kg_dataloaders, train_qa_loaders, dev_qa_loaders):
        ...
        for i, client_data in enumerate(self.all_clients_data):
            ...
            # Initialize entity embeddings (TransE: hidden_dim, then normalize)
            ...
            # Normalize to unit sphere for TransE
            entity_embedding_init = F.normalize(entity_embedding_init, p=2, dim=1)
            ...
            # Initialize KG model (TransE)
            kg_model = TransEModel(self.args)
    ...
    def train_phase1_kg(self):
        ...
        logging.info("\n" + "=" * 70)
        logging.info("PHASE 1: Federated KG Embedding Training (TransE)")
        logging.info("=" * 70)
