"""
Server-side Evaluation Script for DistilBERT-TransE on PathQuestion
"""
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("DistilBERT-TransE Server Evaluation on PathQuestion")
    logging.info("=" * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate DistilBERT-TransE on PathQuestion')
