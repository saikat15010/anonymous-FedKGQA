...
from fkgqa_pathquestion_transe import FederatedKGQA
...
def main(args):
    ...
    logging.info("=" * 70)
    logging.info("Federated KGQA Training - DistilBERT + TransE")
    logging.info("=" * 70)
    ...
    logging.info("=" * 70)
    logging.info(f"Model: TransE for KG, DistilBERT for QA")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Federated KGQA on PathQuestion with DistilBERT + TransE')
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_distilbert_transe',
    ...
    parser.add_argument('--hidden_dim', type=int, default=256,
                       help='Embedding dimension (TransE: entities=hidden_dim, relations=hidden_dim)')
