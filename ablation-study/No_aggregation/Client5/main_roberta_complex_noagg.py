...
from fkgqa_pathquestion_noagg import FederatedKGQA
...
def main(args):
    """Main function to run Federated KGQA training - NO RELATION AGGREGATION"""
    ...
    logging.info("\n" + "=" * 70)
    logging.info("Initializing Federated KGQA System - NO RELATION AGGREGATION")
    logging.info("=" * 70)
    ...
    logging.info(f"ABLATION: Each client maintains SEPARATE relation embeddings")
    ...
    # Train
    logging.info("\n" + "=" * 70)
    logging.info("Starting Training - NO RELATION AGGREGATION")
    logging.info("=" * 70)
    fkgqa.train()
    ...
    logging.info(f"Note: Each client has SEPARATE relation embeddings (no aggregation)")


if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Federated KGQA on PathQuestion - NO RELATION AGGREGATION - RoBERTa + ComplEx'
    )
    ...
    # Output directories
    parser.add_argument('--name', type=str, default='fkgqa_roberta_complex_noagg',
